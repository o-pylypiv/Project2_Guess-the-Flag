...
//  Project2
//
//  Created by Olha Pylypiv on 19.12.2023.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        countries += ["estonia", "france", "germany", "ireland", "italy", "monaco", "nigeria", "poland", "ukraine", "spain", "uk", "us"]
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        if questions != 10 {
            ...
            let ac = UIAlertController(title: "You have answered 10 questions", message: "Final score: \(score)", preferredStyle: .alert)
